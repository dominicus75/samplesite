...
interface EntityInterface {
  ...
  /**
   * Must return with $this->properties
   *
   */
  public function getProperties(): array;

  /**
   * Must return with $this->updated
   *
   */
  public function getUpdated(): array;

  /**
   * It is used to insert return value of EntityInterface::getProperties()) in this table
   *
   * @param void
   ...
   * @throws InvalidFieldNameException if the requested field not exists
   *
   */
   ...
   *
   */
  public function deleteData(array $key): bool;
